...
lalu jalankan 
```
curl -sfL https://get.k3s.io | sudo sh -s - agent --server https://[ip control]:6443 --token [token yang muncul di control]
```

Untuk menginstall sekaligus untuk join ke kubernets pada komputer control
