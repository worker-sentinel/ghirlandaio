...
```
  pacstrap /mnt base intel-ucode linux-hardened linux-hardened-headers linux-firmware mkinitcpio lvm2 sudo curl neovim iwd firewalld pacman podman
```
...
**30. Konfigurasi Proses Boot Kernel Linux-Hardened**
```
...
**35. Konfigurasi Preset Kernel Linux-Hardened**
```
nvim /etc/mkinitcpio.d/linux-hardened.preset
```
