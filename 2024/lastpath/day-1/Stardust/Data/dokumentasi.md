...
```
```
mount --mkdir -o uid=0,gid=0,fmask=0077,dmask=0077 /dev/partition /mnt/boot
```
## var
```
...
```
tambahkan `sd-encrypt` dan `lvm` setelah `sd-vconsole`
```
...
```
samakan dengan konfigurasi yan sudah ada
```
