...
```
> ini buat biki logical volume dari partisi
```
...
arch-chroot /mnt 
```
> masuk ke dalam arch-chroot agar biar tidak perlyu /mnt lagi
```
nvim /etc/hostname 
```
> ini kkta buat nama hostname
```
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime 
```
> lalu kita daftarkan bahasa
```
hwclock --systohc
```
> lalu kita generate bahasanya
```
nvim /etc/locale.gen  
```
> kita piliuh bahasa
