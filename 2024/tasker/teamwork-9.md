...
- database dan aplikasi berada di laptop yang berbeda
- menggunakan dokcker dan docker swarm
...
- menggunakan apache untuk reverse proxy
- Impelementasi CIS Docker
- Impelementasi CIS Server secara keseluruhan
- Aplikasi bisa diakses secara dalam jaringan local
- Firewalld telah terkonfigurasi dengan tepat
...
- Aplikasi yang di install adalah Mayan
- menggunakan nginx untuk reverse proxy
- Impelementasi CIS Server secara keseluruhan
- Aplikasi bisa diakses secara dalam jaringan local
- Firewalld telah terkonfigurasi dengan tepat
...
- Aplikasi yang di install adalah Jellyfin
- menggunakan apache untuk reverse proxy
- Impelementasi CIS Server secara keseluruhan
- Aplikasi bisa diakses secara dalam jaringan local
- Firewalld telah terkonfigurasi dengan tepat
...
- presentator yang gagal akan diberikan kesempatan mengulang sebanyak 2 kali 


### pengumpulan
- presentator mengumpulkan penugasan di dalam repo penguasan masing masing pada hari Rabu, 10 Juni 2026 jam 07.30 AM  
...
## Audience
1. Untuk setiap anggota kelas, mulai minggu ini sesi kelas akan diberikan 1 minggu setelah tugas presentator di release. Tepatnya tanggal 12 juni 2026.
2. Mulai dari sesi ini penugasan audience diberikan didalam direktori practice. 
3. Waktu pengerjaan penugasan 2x24 jam, setelah penugasan audience di release.
...
5.  waktu pengumpulan audience secara serentak akan ditutup pada hari Minggu Tanggal 14 Juni jam 23.59 WIB.  
