...
lvcreate -l100%FREE  [namavolumegruop] -n dock  // docker sedikit berbeda karena ini untuk server 
...
mkfs.ext4 -b4096 /dev/[namavolumgroup] /dock <br> 
...
mount --mkdir -o rw,nosuid,nodev,noexec,relatime /dev/[namavolumegroup]/dock /mnt/var/lib/docker <br> 
