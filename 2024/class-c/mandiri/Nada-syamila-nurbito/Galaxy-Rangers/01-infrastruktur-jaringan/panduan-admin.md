...
membuat profil jaringan baru. Gantilah teks di dalam tanda < > dengan konfigurasi jaringanmu yang sebenarnya.
```
...
```
Ganti nama "Admin" dengan nama yang sudah dibuat, contohnya: 
```
