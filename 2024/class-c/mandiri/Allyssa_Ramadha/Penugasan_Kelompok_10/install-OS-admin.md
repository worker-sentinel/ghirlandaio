...
```
<img width="723" height="820" alt="foto a" src="https://github.com/user-attachments/assets/a3f6ab35-bd99-4f31-97b7-1941a5f35618" />

## Mengupdate konfigurasi pam_mount
```
nvim /etc/pam.d/system-login
```
<img width="565" height="403" alt="foto b" src="https://github.com/user-attachments/assets/99ee1aed-389a-4500-aeb3-cf56bd1088d1" />

## Booster
```
nvim /etc/booster.yaml
```
<img width="217" height="114" alt="foto c" src="https://github.com/user-attachments/assets/c01579a1-5f01-4408-8d91-59496dab23a7" />
