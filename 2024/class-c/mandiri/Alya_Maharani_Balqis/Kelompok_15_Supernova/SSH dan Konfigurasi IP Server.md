...
```
sudo nvim /etc /system/network/20-ethernet.network
[Match]                                                                                                                                                                                   Type=ether                                                                                                                                                                                    Kind=!*
[Link]                                                                                                                                                                                        RequiredForOnline=routable 
[Network]                                                                                                                                                                                     Address=15.15.5.7/24                                                                                                                                                                          Gateway=15.15.5.8                                                                                                                                                                             DNS=1.1.1.1 8.8.8.8                                                                                                                                                                           MulticastDNS=yes 
...
## Restart dan enable system-networkd
```
