...
## Mounting
```
mount /dev/wc/root /mnt                                                                                                                                mount --mkdir -o uid=0,gid=0,fmask=0077,dmask=0077 /dev/nvme0n1p6 /mnt/boot
mount --mkdir -o rw,nodev,nosuid,relatime /dev/wc/vars /mnt/var                                                                                        mount --mkdir -o rw,nodev,noexec,nosuid,relatime /dev/wc/vlog /mnt/var/log                                                                             mount --mkdir -o rw,nodev,noexec,nosuid,relatime /dev/wc/vaud /mnt/var/log/audit                                                                       mount --mkdir -o rw,nodev,noexec,nosuid,relatime /dev/wc/home /mnt/home                                                                                mount --mkdir -o rw,nodev,noexec,nosuid,relatime /dev/wc/vtmp /mnt/var/tmp                                                                             mount --mkdir -o rw,nodev,noexec,nosuid,relatime /dev/wc/podman /mnt/var/lib/containers 
```
lsblk
```
...
<volume                                                                                                                                                                      user="milky"                                                                                                                                                              fstype="crypt"                                                                                                                                                           path="/dev/wc/lit"                                                                                                                                                     mountpoint="/home/user" 

```
nvim /etc/pam.d/system-login
```
#%PAM-1.0                                                                                                                                                                                                                                                                                                                                          auth       required   pam_shells.so                                                                                                                                       auth       requisite  pam_nologin.so                                                                                                                                      auth       include    system-auth                                                                                                                                         auth       required   pam_mount.so     (tambahan)                                                                                                                                                                                                                                                                                                            

account    required   pam_access.so                                                                                                                                       account    required   pam_nologin.so                                                                                                                                      account    include    system-auth                                                                                                                                                                                                                                                                                                                  password   include    system-auth                                                                                                                                                                                                                                                                                                                  

session    optional   pam_loginuid.so                                                                                                                                     session    optional   pam_keyinit.so       force revoke                                                                                                                   session    include    system-auth                                                                                                                                         session    optional   pam_lastlog2.so      silent                                                                                                                         session    optional   pam_motd.so                                                                                                                                         session    optional   pam_mail.so          dir=/var/spool/mail standard quiet                                                                                             session    optional   pam_umask.so                                                                                                                                        session    optional   pam_mount.so         (tambahan)                                                                                                                               -session   optional   pam_systemd.so                                                                                                                                      session    required   pam_env.so                                                                                                                                          ~                                                   
